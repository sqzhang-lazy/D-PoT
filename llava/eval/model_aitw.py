...
def eval_model(args):
    ...
    for i, line in enumerate(tqdm(questions)):
        ...
        qs = question['value'].replace('<image>', '').strip().split("Plan")[0]+"Please formulate an operational guide for future operations for solving the goal. The guide includes:" + \
